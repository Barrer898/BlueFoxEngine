...
/// <summary>
/// Compiles YueScript source code to Lua bytecode using the
...
/// is cleaned up after every compile, so callers can reuse the
/// compiler concurrently with separate runtime instances.
/// </summary>
public static class YueScriptComplier
{
    ...
    /// <summary>
    /// Compiles YueScript source code to Lua bytecode.
    ///
    ...
    /// <returns>Compiled Lua bytecode as a string.</returns>
    public static string Compile(string source)
    {
        ...
        // Read and clean up the compiled bytecode result.
