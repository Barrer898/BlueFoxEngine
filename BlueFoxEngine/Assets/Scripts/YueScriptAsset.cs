...
/// Lua bytecode. Compilation is performed lazily on first use, or
...
/// </summary>
public class YueScriptAsset : Object
{
    ...
    /// <summary>
    /// The compiled Lua bytecode. Null before successful compilation.
    /// </summary>
    ...
    /// <summary>
    /// Reads the source file from disk and compiles it to Lua bytecode.
    /// </summary>
    ...
    /// <summary>
    /// Overrides the base dispose logic to release the compiled Lua bytecode.
    /// </summary>
